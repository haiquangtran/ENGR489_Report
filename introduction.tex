...
\todo{	Add in a report structure section as well: This report is organized as follows: Chapter~\ref{chap:relatedwork} discusses related work etc. etc. Note, this only works if you put \label{chap:relatedwork} under the \chapter{Related Work} tag.}
