...
\begin{itemize}
	...
	\item{no participants were intolerant to diary}
	\item{no participants were intolerant to egg}
	\item{no participants specified other intolerances}
\end{itemize}
...
\todo{Removed the location and price information to remove biases around that (since students etc).}
